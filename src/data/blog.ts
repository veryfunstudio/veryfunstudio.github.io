...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "The concept of a 'core loop' is fundamental to good design. A core loop is the cycle of actions a player repeats throughout your game. In our match-three puzzles, it's simple: scan the board, spot a triple, tap to clear, feel satisfaction, then read the next arrangement. The best games make this loop so satisfying that players want to repeat it hundreds or thousands of times. If your core loop feels like work, no amount of polish will save it.",
