...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      "The Unity versus Unreal debate is one of the most heated topics in game development, and for good reason — your engine choice affects everything from workflow to performance to hiring. At VeryFun Company, our entire mobile lineup ships on Unity, but we've prototyped extensively in Unreal for internal R&D. Here's our honest comparison based on real day-to-day experience.",
      "Unity's greatest strength is accessibility. C# is an incredibly beginner-friendly language, and the Asset Store ecosystem means you can prototype rapidly using existing tools. For 2D and casual 3D mobile games specifically, Unity's toolset is mature and well-documented. We built Tile Journey and Pearl Coloring in Unity because the lightweight runtime, mobile-friendly build pipeline, and rich 2D/3D hybrid workflow felt natural for those projects. The learning curve is gentle — a motivated developer can ship their first Unity game in 3-6 months.",
      "Unreal Engine, conversely, excels in 3D fidelity and visual polish out of the box. Blueprints visual scripting is surprisingly powerful — designers can implement gameplay features without writing code. The rendering pipeline (Lumen, Nanite) produces stunning results with minimal configuration. We don't currently ship on Unreal — our casual mobile focus doesn't justify the runtime cost — but when we prototyped a 3D action concept internally, the visual quality was immediately ahead of what we'd build in Unity. That said, the C++ learning curve is steep, compile times can slow iteration, and the runtime footprint is heavy for low-end Android devices.",
      ...
      "Our recommendation? If you're making a 2D game, a casual mobile title, or your team is new to development, start with Unity. If you're targeting high-fidelity 3D on PC/console or have experienced programmers comfortable with C++, choose Unreal. But honestly? The best engine is the one your team knows deeply. Switching engines mid-project is painful. Pick one, commit to it, and master its quirks.",
    ],
  },
  {
    id: 4,
